...
namespace DotNetAppSqlDb.Controllers
{
    public class TodosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Description,CreatedDate")] Todo todo)
        {
            ...
            {
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create("https://jptestf001.azurewebsites.net/api/Function1?code=H14uuB7PASwcn1jQLH7hkXeuBa4ZkG24worJWKsu0OaMWYKnF9QnAQ==&name=JohnRanaudo");
                request.Method = "GET";
